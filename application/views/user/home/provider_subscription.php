					...
					<div class="col-xl-4 col-md-6 <?php echo $class; ?>">
						<div class="card">
							<div class="card-body">
								...
								<?php
								if(empty($subscription_name['subscription_name'])){ ?>
				...
				<div class="card">
					<div class="card-body">
						<div class="plan-det">
							...
							<ul class="row">
								<li class="col-sm-4">
									<p><span class="text-muted">Started On</span> <?php  if(!empty($my_subscribe['subscription_date'])){echo date('d M Y',strtotime($my_subscribe['subscription_date']));} ?></p>
								</li>
								<li class="col-sm-4">
									<p><span class="text-muted">Price</span> $<?php if(!empty($subscription_name['fee'])){echo $subscription_name['fee']; }
									?></p>
								</li>
								<li class="col-sm-4">
							...
							<ul class="row">
								<li class="col-sm-4">
									<p>Paid at <?php  if(!empty($my_subscribe['expiry_date_time'])){echo date('d M Y',strtotime($my_subscribe['subscription_date'])); }?></p>
								</li>
								<li class="col-sm-4">
									<p><span class="amount">$<?php if(!empty($subscription_name['fee'])){ echo $subscription_name['fee'];}?> </span> <span class="badge bg-success-light">Paid</span></p>
								</li>
							</ul>
						</div>
					</div>
